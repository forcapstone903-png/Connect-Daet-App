...
const en = {
  ...
  'settings.status.loadFailed': 'Account settings could not be loaded. Reload before saving account changes.',
  ...
  'settings.security.deactivate': 'Deactivate account',
  'settings.security.deactivateHint': 'Pause your account and hide it from the community until you reactivate it.',
  'settings.security.deactivateConfirm': 'Your account will be deactivated and you will be signed out. You can reactivate it after signing in again.',
  'settings.security.reactivate': 'Reactivate account',
  'settings.security.reactivateHint': 'Restore your account and return it to the community.',
  'settings.security.reactivated': 'Your account has been reactivated.',
  'settings.security.deleteAccount': 'Delete account',
  'settings.security.deleteAccountHint': 'Schedule permanent deletion. You have 30 days to cancel.',
  'settings.security.deleteAccountConfirm': 'Your account will be hidden now and permanently deleted after 30 days. You will be signed out, and you can cancel the request by signing in again before the deadline.',
  'settings.security.deletionScheduled': 'Deletion scheduled',
  'settings.security.deletionScheduledHint': 'Your account is scheduled for deletion on',
  'settings.security.cancelDeletion': 'Cancel deletion',
  'settings.security.deletionCancelled': 'Your account deletion request has been cancelled.',
  ...
  'settings.legal.developers': 'About the developers',
  'settings.legal.developersHint': 'Meet the team maintaining CONNECT-Daet.',
  'settings.legal.support': 'Send feedback',
  'settings.legal.supportHint': 'Report a problem or suggest an improvement.',
  'settings.legal.cookiePolicy': 'Cookie policy',
  'settings.legal.cookiePolicyHint': 'How consent cookies and local storage are used.',
  'settings.legal.accessibility': 'Accessibility',
  'settings.legal.accessibilityHint': 'How the app supports low-vision and reduced-motion users.',
...
const fil = {
  ...
  'common.events': 'Mga Event',
  'common.logOut': 'Mag-log out',
  'common.confirmLogout': 'Kumpirmahin ang Pag-log out',
  'common.confirmLogoutMessage': 'Sigurado ka bang gusto mong mag-log out?',
  ...
  'settings.language.preview': 'Preview',
  'settings.status.loadFailed': 'Hindi ma-load ang account settings. I-reload bago mag-save ng mga pagbabago.',

  'settings.notifications.title': 'Abiso',
  'settings.notifications.description': 'Kontrolin ang ipinapadalang abiso ng komunidad.',
  'settings.notifications.emailAlerts': 'Mga alert sa email',
  ...
  'settings.security.deactivate': 'I-deactivate ang account',
  'settings.security.deactivateHint': 'I-pause ang account at itago ito sa komunidad hanggang i-reactivate mo ito.',
  'settings.security.deactivateConfirm': 'Ide-deactivate ang account at ika ay ila-log out. Maaari mo itong i-reactivate pagkatapos muling mag-sign in.',
  'settings.security.reactivate': 'I-reactivate ang account',
  'settings.security.reactivateHint': 'Ibalik ang account at ipakita itong muli sa komunidad.',
  'settings.security.reactivated': 'Na-reactivate na ang account.',
  'settings.security.deleteAccount': 'Burahin ang account',
  'settings.security.deleteAccountHint': 'I-schedule ang permanenteng pagbura. May 30 araw ka para magkansela.',
  'settings.security.deleteAccountConfirm': 'Itatago ang account ngayon at permanenteng buburahin pagkalipas ng 30 araw. Ila-log out ka, at maaari mong kanselahin ito sa muling pag-sign in bago ang deadline.',
  'settings.security.deletionScheduled': 'Naka-schedule ang pagbura',
  'settings.security.deletionScheduledHint': 'Naka-schedule ang pagbura ng account sa',
  'settings.security.cancelDeletion': 'Kanselahin ang pagbura',
  'settings.security.deletionCancelled': 'Nakansela na ang request na pagbura ng account.',
  ...
  'settings.data.installReady': 'Gamitin ang install prompt kung available, o ang browser menu.',
  ...
  'settings.legal.developers': 'Tungkol sa mga developer',
  'settings.legal.developersHint': 'Kilalanin ang team na nagpapanatili ng CONNECT-Daet.',
  'settings.legal.support': 'Magpadala ng feedback',
  'settings.legal.supportHint': 'Mag-ulat ng problema o magmungkahi ng pagbabago.',
  'settings.legal.cookiePolicy': 'Patakaran sa cookies',
  'settings.legal.cookiePolicyHint': 'Paano ginagamit ang consent cookies at local storage.',
  'settings.legal.accessibility': 'Accessibility',
  'settings.legal.accessibilityHint': 'Paano sinusuportahan ng app ang low-vision at reduced-motion users.',
...
const bik = {
  ...
  'common.feed': 'Feed',
  'common.forums': 'Forum',
  'common.create': 'Maghimo',
  'common.blogs': 'Mga Blog',
  'common.events': 'Mga Event',
  'common.logOut': 'Mag-log out',
  'common.confirmLogout': 'Kumpirmahon an Pag-log out',
  'common.confirmLogoutMessage': 'Sigurado ka ba na gusto mong mag-log out?',
  'common.loggingOut': 'Nagi-log out...',
  ...
  'settings.language.preview': 'Preview',
  'settings.status.loadFailed': 'Dai ma-load an account settings. I-reload bago mag-save kan mga binago.',
  ...
  'settings.security.deactivate': 'I-deactivate an account',
  'settings.security.deactivateHint': 'I-pause an account asin itago ini sa komunidad sagkod i-reactivate mo ini.',
  'settings.security.deactivateConfirm': 'Ide-deactivate an account asin ika ila-log out. Puwede mo ini i-reactivate pagkatapos mag-sign in giraray.',
  'settings.security.reactivate': 'I-reactivate an account',
  'settings.security.reactivateHint': 'Ibalik an account asin ipahiling giraray sa komunidad.',
  'settings.security.reactivated': 'Na-reactivate na an account.',
  'settings.security.deleteAccount': 'Buraon an account',
  'settings.security.deleteAccountHint': 'I-schedule an permanenteng pagbura. May 30 aldaw ka para magkansela.',
  'settings.security.deleteAccountConfirm': 'Itatago an account ngunyan asin permanenteng buburahon pagkatapos kan 30 aldaw. Ila-log out ka, asin puwede mong kanselahon ini sa pag-sign in giraray bago an deadline.',
  'settings.security.deletionScheduled': 'Naka-schedule an pagbura',
  'settings.security.deletionScheduledHint': 'Naka-schedule an pagbura kan account sa',
  'settings.security.cancelDeletion': 'Kanselahon an pagbura',
  'settings.security.deletionCancelled': 'Nakansela na an request na pagbura kan account.',
  ...
  'settings.data.installReady': 'Gamiton an install prompt kun available, o an browser menu.',
  ...
  'settings.legal.dataPrivacy': 'Paunawa sa Data Privacy Act',
  'settings.legal.developers': 'Manungod sa mga developer',
  'settings.legal.developersHint': 'Kilalahon an team na nagmamentenar kan CONNECT-Daet.',
  'settings.legal.support': 'Magpadara nin feedback',  'settings.legal.supportHint': 'Mag-ulat nin problema o magmungkahi nin pagbabago.',
  'settings.legal.cookiePolicy': 'Patakaran sa cookies',
  'settings.legal.cookiePolicyHint': 'Paano ginagamit an consent cookies asin local storage.',
  'settings.legal.accessibility': 'Accessibility',
  'settings.legal.accessibilityHint': 'Paano sinusuportahan kan app an low-vision asin reduced-motion users.',
