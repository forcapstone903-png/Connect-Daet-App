// Simple icon component system
export function Icon({ name, className = '' }) {
  // ensure a sensible default size, allow callers to override with explicit w-/h- classes
  const classes = `w-5 h-5 ${className}`.trim();

  const iconMap = {
    // Navigation
    dashboard: (
      <svg className={classes} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 12l2-3m0 0l7-4 7 4M5 9v10a1 1 0 001 1h12a1 1 0 001-1V9m-9 11l4-4m0 0l4-4" />
      </svg>
    ),
    content: (
      <svg className={classes} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    users: (
      <svg className={classes} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 4.354a4 4 0 110 8.646 4 4 0 010-8.646zM9 16H3v2a6 6 0 006 6h6a6 6 0 006-6v-2h-6a2 2 0 00-2 2v2h-3v-2a2 2 0 00-2-2z" />
      </svg>
    ),
    moderation: (
      <svg className={classes} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    image: (
      <svg className={classes} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 13l2-2 3 3 4-4 3 3" />
      </svg>
    ),
    video: (
      <svg className={classes} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <rect x="3" y="6" width="10" height="12" rx="2" ry="2" strokeWidth={1.5} />
      </svg>
    ),
    close: (
      <svg className={classes} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    warning: (
      <svg className={classes} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 9v2m0 4v2m-6.364-6.364l1.414-1.414M12 9.172l1.414 1.414M19.364 8.828l1.414 1.414M19.364 19.364l-1.414-1.414M15.778 15.778l1.414 1.414M3.636 3.636l1.414 1.414m0 12.728l-1.414 1.414" />
      </svg>
    ),
    search: (
      <svg className={classes} fill="none" stroke="currentColor" viewBox="0 0 24 24">
