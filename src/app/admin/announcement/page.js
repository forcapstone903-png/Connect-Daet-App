    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="fixed left-0 top-0 h-full w-64 bg-white border-r border-gray-200 z-20 shadow-sm">
        ...
        <nav className="mt-4 px-3">
          ...
          <Link href="/admin/announcement" className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-blue-50 text-blue-700 mb-1">
            <span className="text-xl">📢</span>
            <span className="font-medium text-blue-700">Announcement</span>
          </Link>
