        ...
        <aside className="space-y-4">
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-4 shadow-sm">
            ...
            <div className="space-y-2">
              <button onClick={() => router.push('/tourist-spots')} className="flex w-full items-center justify-between rounded-2xl bg-slate-50 px-3 py-2 text-sm text-slate-700 hover:bg-slate-100">
                <span>{language === 'en' ? 'Explore all spots' : 'Tuklasin ang lahat ng pook'}</span>
