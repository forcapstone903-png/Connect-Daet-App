...
-- The app writes user-facing notifications to info_notifications. The existing
-- push webhook listens to public.notifications, so bridge every new app
-- notification into that push queue table.
